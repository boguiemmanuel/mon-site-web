...
<br></br>
    <main>
       <header>
                <div class="photo">
                    <img src="images/32.jpg" width="100%" height="100%" alt="">
                </div>
              <div class="des">
                    <h3>BODJUI EMMANUEL DIEUDONNE</h3>
                    <p class="post">Développeur Web </p>
                </div>
                <div class="right">
                        <p><img src="tele.png" class="info"> bodjuiemmanuel388@gmail.com</p>
                        <p><img src="tele.png" class="info"> tel: +22547860451</p>
                </div> 
       </header>
...
<section class="section-left">
    ...
    <hr class="light">
       <div class="div">
           ...
           </b><strong>entreprise/ecole</strong>  ville, Lieux <br>La de Date
           </div>
           <br>
           <div><b>Certificat de spécialisation en développement web et d'application
     ...
     <hr class="light">
        <div class="div">
          ...
          <p><b>Stagiaire Développeur web</b> <strong>(ENTREPRISE)</strong>, (lieux)<br>
             (date)<br>
            Développement d'une application web <strong>(ENTREPRISE)</strong>.
         </p>  
