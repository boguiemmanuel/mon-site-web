...
<body>
    ...
    <header>
        <h1><samp style="color: red;margin-left:500px"> developpeur</samp><samp style="color: blue;"> web</samp></h1>
...
window.onload = changeimage;
        ...
        <div class="content">
            <div class="card">
                ...
                <div class="right">
                    ...
                    <img src="images/28.jpg" style="width:100% ; height : 900px" alt="">
                </div>
            </div>
    ...
    <h1 align ="center"> <samp style="color:red;font-size:47px;">  sujection pour l'amélioration de mon site web</samp> </h1>
